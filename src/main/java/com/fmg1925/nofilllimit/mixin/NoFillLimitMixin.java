		...
		MutableText message = Text.literal("Filling from ")
				...
				.append(Text.literal("[%d, %d, %d]".formatted(x1, y1, z1))
						.setStyle(Style.EMPTY
								...
								.withClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, cmdStart))
								.withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, hintStart))
						))
				...
				.append(Text.literal("[%d, %d, %d]".formatted(x2, y2, z2))
						.setStyle(Style.EMPTY
								.withColor(Formatting.GREEN)
								.withClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, cmdEnd))
								.withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, hintEnd))
						));
